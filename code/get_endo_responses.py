...
def main():
    ...
    # Set prompts
    prompts = {'no_prompt': '',
               'doc_prompt': 'You are a doctor with specialty in endometriosis. Answer the question in this post from a patient in an online board. Make sure to keep your answer under 200 words and do not hedge your answer.\n\nAnswer:',
               'pat_prompt': 'You are a patient with endometriosis, who has expertise in the disease. Answer the question in this post from a fellow patient in an online board. Make sure to keep your answer under 200 words and do not hedge your answer.\n\nAnswer:'}

    # Output folder for endo answers
    output_dir = os.path.join(out_dir, 'endo_responses')
    os.makedirs(output_dir, exist_ok=True)

    # Source file with endo questions
    questions = pd.read_csv(os.path.join(dir, 'data', 'endo_questions.csv'))
